...
const styles = {
  ...
  hero: {
    ...
    textAlign: 'center',
    // On réduit l'inclinaison pour ne pas couper le formulaire
  ...
  container: {
    width: '90%',
    maxWidth: '650px',
    margin: '-80px auto 100px auto', // Remonte le formulaire sur le bleu
    zIndex: 10, // Assure que le formulaire est au-dessus du bleu
    position: 'relative'
  },
  formCard: {
  ...
  input: {
    ...
    fontSize: '1rem',
    color: '#1e293b', // Texte foncé pour être visible
    backgroundColor: '#ffffff',
    outline: 'none',
    transition: 'all 0.2s'
  },
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cette erreur s'affiche si votre serveur Java n'est pas lancé
