...
import com.pixeldev.txlforma.model.Inscription; // IMPORTANT : Import du modèle Inscription
import com.pixeldev.txlforma.service.UtilisateurService;
import com.pixeldev.txlforma.repository.InscriptionRepository; // IMPORTANT : Import du repository
...
public class UtilisateurController {
    ...
    // Injection du repository pour récupérer la liste brute des inscriptions
    @Autowired
    ...
    // Permet de récupérer la liste complète des inscriptions (pour le tableau du bas)
